...
# `semi_join`  To make sure we do not include users and movies in the validation that do not appear in the edx set.
...
rmses <-  RMSE(predicted_ratings, validation$rating)
